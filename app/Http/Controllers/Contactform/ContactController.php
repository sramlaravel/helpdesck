...
class ContactController extends Controller
{
    ...
    public function saveContact(Request $request) {
        ...
        try{
           // dd($contactData['Contact_email']);
//   dd(setting('mail_from_address') );

             sendEmail( $request->email,'customer_sendmail_contactus', $contactData);
            sendEmail( setting('mail_from_address'), 'admin_sendmail_contactus', $contactData );
   //  Mail::to( $request->email ) ->send( new mailmailablesend( 'customer_sendmail_contactus', $contactData ) );

         //   Mail::to(  setting('mail_from_address') )  ->send( new mailmailablesend( 'admin_sendmail_contactus', $contactData ) );

        }catch(\Exception $e){
return $e;
            return back()->with('error', trans('langconvert.functions.contactpage'));
        }
