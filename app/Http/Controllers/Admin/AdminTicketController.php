...
class AdminTicketController extends Controller
{
    ...
    public function gueststore(Request $request)
    {
        ...
        try{
            sendEmail( $ticket->cust->email,'customer_send_guestticket_created', $ticketData );
            sendEmail( setting('mail_from_address'), 'admin_send_email_ticket_created', $ticketData  );
